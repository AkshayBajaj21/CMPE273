...
nextPageHandler = (e) => {
 ...
 new Promise((resolve,reject) =>{
  ...
  .then( (value) =>{
    ...
    axios.get(`http://localhost:3001/course/${this.state.page}`)
    .then((response)=>{
...
// }
  ...
  componentDidMount(){
   console.log("data at course page from graphql is ",this.props) 
  ...
  render() {
   // console.log("name of course is" +courses.coursename[0]);
    ...
    console.log("role of user is ",isStudent)
...
export default (connect(mapStateToProps, mapDispatchToProps)(Courses),graphql(getCoursesQuery)(Courses));
